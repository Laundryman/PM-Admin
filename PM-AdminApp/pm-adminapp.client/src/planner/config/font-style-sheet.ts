...
const OPEN_SANS_URL = '/public/assets/fonts/OpenSans.ttf';
const DM_SANS_URL = '/public/assets/fonts/DMSans.ttf';
const ROBOTO_FLEX_URL = '/public/assets/fonts/RobotoFlex.ttf';
